...
export declare const LogicGateService: {
    ...
    _testAnd(condition: AndConditionDto, conditions: [Condition, true | Condition][]): true | Condition;
    _testNAnd(condition: NandConditionDto, conditions: [Condition, true | Condition][]): true | Condition;
    _testNor(condition: NorConditionDto, conditions: [Condition, true | Condition][]): true | Condition;
    _testOr(condition: OrConditionDto, conditions: [Condition, true | Condition][]): true | Condition;
    _testXOr(condition: XorConditionDto, conditions: [Condition, true | Condition][]): true | Condition;
};
