...
export * from './dto/conditions/comparisons/like.condition.dto';
export * from './dto/conditions/comparisons/pattern.condition.dto';
...
export * from './services/likeness.service';
